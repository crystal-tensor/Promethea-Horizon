...
- Manifest hash: `2d5171cc83e777de1ada49d3aac825aecde522cfb724fb7da602983dae1afabd`
- Requirements passed/failed: `8` / `1`
- Failed requirement IDs: `['P1']`
...
- P1 [FAIL]: Observable provenance manifest gate remains valid and blocked only on P6/P7/P8
...
- P6 [PASS]: Replay-validation manifest artifact has been submitted
- P7 [PASS]: Submitted manifest satisfies the locked replay-validation schema
- P8 [PASS]: Submitted manifest is source-backed, provenance-bound, replay-bound, and claim-boundary-bound
...
- validation_error_count: 2
- unexpected observable replay-validation manifest failures: ['P1']
- gate expected no submitted replay-validation manifest until an observable PR supplies one
