...
def validate_report(report: dict) -> list[str]:
    errors: list[str] = []
    if report.get("status") != "named_family_width_locality_bound_skeleton_checked_interface_not_theorem":
        errors.append("status must identify the checked interface and unformalized named-family theorem")
