#!/usr/bin/env python3
"""Freeze R177 Linux x86-64 build and replay before workflow dispatch."""
...
METHOD = "b4_b8_r177_linux_x86_64_protocol_v0"
...
REPORT_PATH = "research/B4_B8_R177_linux_x86_64_protocol.md"
...
RESULT_PATHS = [
    "research/source_lineage/Qiskit_2_4_1_R177_fixed_superaccumulator_accelerate.x86_64-linux-gnu.so",
    "research/source_lineage/Qiskit_2_4_1_R177_linux_x86_64_build_manifest.json",
    "research/source_lineage/R177_linux_x86_64_build_logs",
    "research/B4_B8_R177_linux_x86_64_replay.md",
    "research/B4_B8_R177_independent_linux_x86_64_oracle.md",
    "results/B4_B8_R177_linux_x86_64_replay",
    "results/B4_B8_R177_linux_x86_64_replay_v0.json",
    "results/B4_B8_R177_independent_linux_x86_64_oracle_v0.json",
    "results/B4_B8_R177_linux_x86_64_bundle_manifest_v0.json",
]
TOOLS = [
    "tools/b4_b8_r177_linux_x86_64_preregister.py",
    "tools/b4_b8_r177_linux_x86_64_build.py",
    "tools/b4_b8_r177_linux_x86_64_replay.py",
    "tools/b4_b8_r177_independent_linux_x86_64_oracle.py",
    "tools/b4_b8_r177_linux_x86_64_bundle.py",
    "tools/b4_b8_r176_fixed_superaccumulator_replay.py",
    "tools/b4_b8_r176_independent_fixed_accumulator_oracle.py",
    ".github/workflows/r177-linux-x86-64.yml",
]
...
def source_binding(root: Path, relative: str) -> dict[str, Any]:
    path = root / relative
    if not path.is_file():
        raise ValueError(f"R177 source binding is missing: {relative}")
...
def main() -> int:
    ...
    for relative in [PROTOCOL_PATH, CONTRACT_PATH, REPORT_PATH, *RESULT_PATHS]:
        if (root / relative).exists():
            raise ValueError(f"R177 output already exists: {relative}")
    ...
    protocol.update(
        {
            "title": "B4/B8/B10 R177 Linux x86-64 independent replay protocol",
            "version": 0,
            "method": METHOD,
            "status": "preregistered_unopened",
            "source_target_id": "T-B4-002dc/T-B8-003dg/T-B10-009cs-r177-protocol",
            "upstream_target_id": "T-B4-002da/T-B8-003de/T-B10-009cq-r176-result",
            "research_question": "Does an independently built Ubuntu x86-64 accelerator reproduce the full R176 exact-selection result and remain inside the same frozen local performance gates?",
            "platform_contract": {
            ...
            "acceptance_requirements": [
                ...
                "a standard-library oracle imports neither Qiskit nor the R177 executor and reproduces every outcome",
    ...
    contract = {
        "contract_id": "B4-B8-R177-linux-x86-64-contract-v0",
