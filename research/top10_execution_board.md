...
Current state: **stage 1v evidence hardening; B2 now has a hardware-like leakage observation model gate but it remains a negative boundary, B5 has a canonical-environment smoke gate with 0 passed rows, B6 has a structural/electronic proxy boundary, and B10 remains a denominator-boundary track**.
