...
Current state: **stage 1n evidence hardening; B6 now has a structural/electronic proxy boundary that beats formula-only ranking but still loses to family priors, while B2 and B10 remain boundary-stress tracks**.
